...
from raffaello.src.raffaello import parse_request, parse_string_request
...
'''
        ...
        raf = Raffaello(parse_string_request(request))
...
another_match=>red
'''
        commission = parse_string_request(request)
